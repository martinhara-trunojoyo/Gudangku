        ...
        <li className="relative">
          ...
          {dropdownLaporan && (
            <ul className="absolute top-full right-0 mt-2 bg-white border rounded shadow-lg w-44 z-10 py-1">
              <li><Link to="/admin/laporan/masuk" className="block px-4 py-2 hover:bg-purple-50 text-gray-700">Laporan Masuk</Link></li>
              <li><Link to="/admin/laporan/keluar" className="block px-4 py-2 hover:bg-purple-50 text-gray-700">Laporan Keluar</Link></li>
            </ul>
          )}
        </li>
