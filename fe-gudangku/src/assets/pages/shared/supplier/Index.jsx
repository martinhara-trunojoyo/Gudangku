                        ...
                        <table className="w-full">
                            ...
                            <tbody>
                                <tr className="border-b hover:bg-gray-50">
                                    ...
                                    <td className="py-3 px-4">085440xxxxx</td>
                                    <td className="py-3 px-4">Jl. Raya Terang No. 123</td>
                                ...
                                <tr className="border-b hover:bg-gray-50">
                                    ...
                                    <td className="py-3 px-4">081234xxxxx</td>
                                    <td className="py-3 px-4">Jl. Sudirman No. 45</td>
                                    <td className="py-3 px-4">
                                        <div className="flex justify-center gap-2">
                                            <button
                                ...
                                <tr className="border-b hover:bg-gray-50">
                                    ...
                                    <td className="py-3 px-4">089765xxxxx</td>
                                    <td className="py-3 px-4">Jl. Pahlawan No. 78</td>
                                    <td className="py-3 px-4">
                                        <div className="flex justify-center gap-2">
                                            <button
