                        ...
                        <table className="w-full">
                            ...
                            <tbody>
                                <tr className="border-b hover:bg-gray-50">
                                    ...
                                    <td className="py-3 px-4">Pengiriman ke Toko A</td>
                                </tr>
                                <tr className="border-b hover:bg-gray-50">
                                    <td className="py-3 px-4">2</td>
                                    <td className="py-3 px-4">Sabun Herbal Alami</td>
                                    <td className="py-3 px-4">12</td>
                                    <td className="py-3 px-4">2023-05-14</td>
                                    <td className="py-3 px-4">Pengiriman ke Distributor</td>
                                </tr>
                                <tr className="border-b hover:bg-gray-50">
                                    ...
                                    <td className="py-3 px-4">Pemasaran Online</td>
                                </tr>
                                <tr className="border-b hover:bg-gray-50">
                                    ...
                                    <td className="py-3 px-4">Pengiriman ke Toko B</td>
                                </tr>
                                <tr className="border-b hover:bg-gray-50">
                                    <td className="py-3 px-4">5</td>
                                    <td className="py-3 px-4">Sabun Herbal Alami</td>
                                    ...
                                    <td className="py-3 px-4">Pengiriman ke Reseller</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
